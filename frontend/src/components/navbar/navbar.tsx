...
const Navbar = ({links, logo}: NavbarProps) => {
    ...
    return (
        <>
            <div
                className={`hidden lg:flex text-2xl transition duration-300 font-bold bg-background font-serif sticky top-0 -mx-24 px-24 flex-col justify-between z-50 ${scrollY > 0 && 'shadow-[0_6px_12px_0_rgba(0,0,0,0.12)] '}`}>
