...
const CarrouselBtn = ({ direction, onClick }: CarrouselBtnProps) => {
    return (
        <>
            ...
            <div
                className={`absolute w-12 md:w-20 h-full top-0 flex flex-row justify-center items-center cursor-pointer transition duration-300 ${direction === 'left' ? 'left-0' : 'right-0'}`}
                onClick={onClick}
            >
                <div className={''}>
